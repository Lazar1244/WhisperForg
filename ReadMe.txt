...
```mermaid
flowchart LR
  A[Call app<br/>Zoom / Meet / Discord] -->|audio output| B[Audio routing<br/>(Voicemeeter / virtual cable)]
  C[Microphone] --> D[record_externe_interne.py]
  B --> D

  D -->|external_N.wav & internal_N.wav| E[audio_input/]

  E --> F[test_faster_whisper.py<br/>faster-whisper]
